    ...
    private void backListener(){
        ...
        back.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                hobby = favorite.getText().toString();

                final MyUser infor = new MyUser();
                infor.setUsername(name);
                infor.setSignature(sign);
                infor.setSex(sex);
                infor.setAge(year);
                infor.setLocation(city);
                infor.setFavorite(hobby);

                infor.update(new UpdateListener<MyUser>() {
                    @Override
                    public void done(MyUser s, BmobException e) {
                        if (e == null) {
                            Toast.makeText(Menu_Setting.this, "修改成功咯", Toast.LENGTH_SHORT).show();
                            obgID = infor.getObjectId();
                        } else {
                            Toast.makeText(Menu_Setting.this, "修改失败咯", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                ...
                editor.putString("sexuality", sex);
                editor.putString("age", year);
                editor.putString("location", city);
                editor.putString("favorita", hobby);
